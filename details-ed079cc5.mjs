 ...
 */
const k = (t) => (e) => typeof e == "function" ? ((r, n) => (customElements.define(r, n), n))(t, e) : ((r, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = (t, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? { ...e, finisher(r) {
...
function p(t) {
  return (e, r) => r !== void 0 ? S(t, e, r) : C(t, e);
}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x = ({ finisher: t, descriptor: e }) => (r, n) => {
  if (n === void 0) {
...
class O extends b {
  ...
  connectedCallback() {
    super.connectedCallback(), this.shadowRoot && z(
      this.shadowRoot,
      [_]
    );
  }
...
//# sourceMappingURL=details-ed079cc5.mjs.map
