...
var $ = [w], I = { docs: { extractArgTypes: O, extractComponentDescription: A, story: { inline: !0 }, source: { type: p.DYNAMIC, language: "html" } } }, x = [_], F = { renderer: "web-components", ...I };
export {
  x as argTypesEnhancers,
  $ as decorators,
  F as parameters,
  j as render,
  B as renderToCanvas
